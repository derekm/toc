...
|User must carefully over-partition topics to support balanced broker/partition reassignments as the cluster expands as a best practice. Reassignments must be manually determined. Scripts for automating reassignment determinations are available. Reassignments must be manually initiated.
