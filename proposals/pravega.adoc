...
|_Transactions_
|Resumable transactions span stream segments. Transaction segments append to stream segments upon commit, foregoing reader isolation levels. Transaction segments are created for all stream segments, even if unused.
